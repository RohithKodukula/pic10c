...
QT_MOC_LITERAL(1, 5, 10), // "clear_this"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 1), // "x"
QT_MOC_LITERAL(4, 19, 1), // "y"
QT_MOC_LITERAL(5, 21, 12), // "rightClicked"
QT_MOC_LITERAL(6, 34, 5), // "clear"
QT_MOC_LITERAL(7, 40, 15), // "mousePressEvent"
QT_MOC_LITERAL(8, 56, 12), // "QMouseEvent*"
QT_MOC_LITERAL(9, 69, 1) // "e"

    },
    "Cell\0clear_this\0\0x\0y\0rightClicked\0"
    "clear\0mousePressEvent\0QMouseEvent*\0e"
};
...
void Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clear_this((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cell::clear_this)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Cell::*_t)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cell::rightClicked)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Cell::staticMetaObject = {
    { &QStackedWidget::staticMetaObject, qt_meta_stringdata_Cell.data,
...
// SIGNAL 0
void Cell::clear_this(int _t1, int _t2)
{
